...
El Ejercicio 1 no ha sido muy complicado, me he limitado a hacer el mapping de todas las tablas siguiendo las normas puestas.
He tenido alguna complicacion sobretodo con las relaciones internas de la tabla EMPLEADO.

### Ejercicio 2

El Ejercicio 2 ha sido mas complicado y me ha dado mas problemas, sobretodo con el CRUD de PRODUCTOS por las variables de relacion mappeadas que habia que incluir.
He podido resolverlo todo y he cumplido con todas las exigencias que se pedian.

### Ejercicio 3

El Ejercicio 3 ha sido curiosa, el CRUD de empleados no he podido hacerlo porque no podia hacer los selects pero el de departamentos si que lo he hecho con todo lo pedido.
...
https://youtu.be/9oto92vbKyw?si=GqUyKdLaLXjvxBzZ 
---
...
|--------------|-------------|--------------------------------------------------------------------------------|
| Insuficiente |             | He cumplido, todo lo pedido para aprobar                                       |
| Suficiente   | X           | He cumplido, todo lo pedido para aprobar                                       |
| Notable      | X           | He hecho parte del 3, que aunque no sea mucho quizas podria llegar al 6 o al 7 |
| Excelente    |             | No he hecho nada del 4                                                         |
